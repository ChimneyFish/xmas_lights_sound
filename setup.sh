...
wget https://github.com/processing/processing4/releases/download/processing-1293-4.3/processing-4.3-linux-arm64.tgz && tar -xf processing-4.3-linux-arm64.tgz 
$INTP
#
